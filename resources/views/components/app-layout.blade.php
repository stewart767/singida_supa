                ...
                @else
                    ...
                    <div class="space-y-1">
                        ...
                        <div x-show="recruitmentOpen" x-transition class="pl-4 space-y-1" x-cloak>
                            ...
                            <a href="{{ route('admin.recruitment.settings') }}" class="flex items-center px-4 py-2.5 rounded-lg text-[11px] font-bold transition-all {{ request()->routeIs('admin.recruitment.settings') ? 'bg-blue-800 text-white' : 'hover:bg-blue-50 text-slate-600 hover:text-blue-800' }}">Settings</a>
                        </div>
                    </div>
                    @endif
