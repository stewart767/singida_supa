...
class AdminWebController extends Controller
{
    ...
    public function updateApplication(Request $request, Application $application, AdmissionCategoryCalculatorService $categoryCalculator)
    {
        ...
        $validated = $request->validate([
            ...
            'acsee_points' => 'nullable|numeric|min:0|max:35',
        ]);
        ...
        DB::transaction(function () use ($request, $application, $validated, $categoryCalculator) {
            ...
            $academicData = [
                ...
                'gpa' => $admissionType === 'Diploma' ? $gpa : null,
                'csee_number' => $validated['csee_number'] ?? null,
                'csee_year' => $validated['csee_year'] ?? null,
                'csee_school' => $validated['csee_school'] ?? null,
                'acsee_number' => $admissionType === 'Form Six' ? ($validated['acsee_number'] ?? null) : null,
                'acsee_year' => $admissionType === 'Form Six' ? ($validated['acsee_year'] ?? null) : null,
                'acsee_school' => $admissionType === 'Form Six' ? ($validated['acsee_school'] ?? null) : null,
                'acsee_combination' => $admissionType === 'Form Six' ? ($validated['acsee_combination'] ?? null) : null,
                'acsee_subject1' => $admissionType === 'Form Six' ? ($validated['acsee_subject1'] ?? null) : null,
                'acsee_subject2' => $admissionType === 'Form Six' ? ($validated['acsee_subject2'] ?? null) : null,
                'acsee_subject3' => $admissionType === 'Form Six' ? ($validated['acsee_subject3'] ?? null) : null,
                'acsee_grade1' => $admissionType === 'Form Six' && $g1 ? strtoupper($g1) : null,
                'acsee_grade2' => $admissionType === 'Form Six' && $g2 ? strtoupper($g2) : null,
                'acsee_grade3' => $admissionType === 'Form Six' && $g3 ? strtoupper($g3) : null,
                'acsee_gs_grade' => $admissionType === 'Form Six' && !empty($validated['acsee_gs_grade']) ? strtoupper($validated['acsee_gs_grade']) : null,
                'acsee_points' => $admissionType === 'Form Six' ? $points : null,
            ];
