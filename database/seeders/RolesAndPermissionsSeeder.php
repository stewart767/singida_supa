...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        $roles = [
            ...
            ['name' => 'finance_officer', 'display_name' => 'Finance Officer', 'description' => 'Manages application fee payments and control numbers.'],
        ...
        $permissions = [
            ...
            ['name' => 'verify_payments', 'display_name' => 'Manage Payments Desk', 'group' => 'finance'],
